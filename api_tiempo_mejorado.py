...
class Ventana(Frame):
    def __init__(self,master, *args):
        ...
        self.frame5 = Frame(self.master,bg='cyan', highlightbackground='dark violet',highlightthickness=2)
    ...
    def obtener_tiempo(self):
        ...
        API ='https://api.openweathermap.org/data/2.5/weather?q='+ ciudad+'&appid=02bb18015fa396e62887dfb18174f284'
        try:
            ...
            self.localidad['text']=''
    def widgets(self):
        self.inicio = PhotoImage(file='Imagen/buscar.gif')
        self.imagen_temp = PhotoImage(file='Imagen/temp_max.png')
        self.imagen_temp_min= PhotoImage(file='Imagen/temperatura6.png')
        self.imagen_temp_max= PhotoImage(file='Imagen/temperatura6.png')
        self.imagen_humedad = PhotoImage(file='Imagen/temp_max.png')
        self.imagen_viento = PhotoImage(file='Imagen/temp_max.png')
        self.imagen_presion = PhotoImage(file='Imagen/temp_max.png')
        ...
        Label(self.frame2,text='Temperatura', bg='pale green').pack(expand=True)
        ...
        Label(self.frame7,text='Presion', bg='sky blue').pack(expand=True)
...
if __name__ == "__main__":
    ...
    ventana.call('wm', 'iconphoto', ventana._w, PhotoImage(file='Imagen/temperatura6.png'))
